...
// }
//
// struct race_transition_chain : private transition_container
// {
//     bool isCompleted;
//
//     template <typename... Transitions>
//         requires(transition<std::remove_cvref_t<Transitions>> && ...)
//     inline explicit race_transition_chain(Transitions&&... transitions)
//         : transition_container(std::forward<Transitions>(transitions)...),
//           isCompleted(false)
//     {
//     }
...
// template <typename... TransitionRange>
//     requires(transition<std::remove_cvref_t<TransitionRange>> && ...)
// inline static constexpr race_transition_chain race(TransitionRange&&... transitions)
// {
//     return race_transition_chain {std::forward<TransitionRange>(transitions)...};
// }
//
...
struct AnimationTest : Sketch
{
    ...
    sequential_transition_chain chain = sequence(
        ...
        adjust_speed(
            tween(1.0f, easeInOutBack, [this](float progress) {
