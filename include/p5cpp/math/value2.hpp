...
namespace p5cpp
{
    ...
    template <typename T> constexpr value2<T> operator+(const value2<T>& v, T scalar);
    template <typename T> constexpr value2<T> operator-(const value2<T>& v, T scalar);
    template <typename T> constexpr value2<T> operator*(const value2<T>& v, T scalar);
    template <typename T> constexpr value2<T> operator/(const value2<T>& v, T scalar);
    ...
    template <typename T> value2<T>& operator+=(value2<T>& a, const value2<T>& b);
    template <typename T> value2<T>& operator-=(value2<T>& a, const value2<T>& b);
    template <typename T> value2<T>& operator*=(value2<T>& a, const value2<T>& b);
    template <typename T> value2<T>& operator/=(value2<T>& a, const value2<T>& b);

    template <typename T> value2<T>& operator+=(value2<T>& v, T scalar);
    template <typename T> value2<T>& operator-=(value2<T>& v, T scalar);
    template <typename T> value2<T>& operator*=(value2<T>& v, T scalar);
    template <typename T> value2<T>& operator/=(value2<T>& v, T scalar);

    template <typename T> constexpr bool operator==(const value2<T>& a, const value2<T>& b);
    template <typename T> constexpr bool operator!=(const value2<T>& a, const value2<T>& b);

    template <typename T> value2<T> operator+(T scalar, const value2<T>& v);
    template <typename T> value2<T> operator-(T scalar, const value2<T>& v);
    template <typename T> value2<T> operator*(T scalar, const value2<T>& v);
    template <typename T> value2<T> operator/(T scalar, const value2<T>& v);
} // namespace p5cpp
...
namespace p5cpp
{
    ...
    template <typename T> inline constexpr value2<T> operator+(const value2<T>& v, T scalar) { return {v.x + scalar, v.y + scalar}; }
    template <typename T> inline constexpr value2<T> operator-(const value2<T>& v, T scalar) { return {v.x - scalar, v.y - scalar}; }
    template <typename T> inline constexpr value2<T> operator*(const value2<T>& v, T scalar) { return {v.x * scalar, v.y * scalar}; }
    template <typename T> inline constexpr value2<T> operator/(const value2<T>& v, T scalar) { return {v.x / scalar, v.y / scalar}; }
    ...
    template <typename T> inline value2<T>& operator+=(value2<T>& a, const value2<T>& b) { return a = a + b; }
    template <typename T> inline value2<T>& operator-=(value2<T>& a, const value2<T>& b) { return a = a - b; }
    template <typename T> inline value2<T>& operator*=(value2<T>& a, const value2<T>& b) { return a = a * b; }
    template <typename T> inline value2<T>& operator/=(value2<T>& a, const value2<T>& b) { return a = a / b; }
    template <typename T> inline value2<T>& operator+=(value2<T>& v, T scalar) { return v = v + scalar; }
    template <typename T> inline value2<T>& operator-=(value2<T>& v, T scalar) { return v = v - scalar; }
    template <typename T> inline value2<T>& operator*=(value2<T>& v, T scalar) { return v = v * scalar; }
    template <typename T> inline value2<T>& operator/=(value2<T>& v, T scalar) { return v = v / scalar; }

    template <typename T> inline constexpr bool operator==(const value2<T>& a, const value2<T>& b) { return a.x == b.x and a.y == b.y; }
    template <typename T> inline constexpr bool operator!=(const value2<T>& a, const value2<T>& b) { return not(a == b); }

    template <typename T> inline value2<T> operator+(T scalar, const value2<T>& v) { return v + scalar; }
    template <typename T> inline value2<T> operator-(T scalar, const value2<T>& v) { return {scalar - v.x, scalar - v.y}; }
    template <typename T> inline value2<T> operator*(T scalar, const value2<T>& v) { return v * scalar; }
    template <typename T> inline value2<T> operator/(T scalar, const value2<T>& v) { return {scalar / v.x, scalar / v.y}; }
} // namespace p5cpp
