...
namespace p5
{
    ...
    struct DrawCommand
    {
        ...
        std::vector<LocatedUniform> uniforms; // A snapshot of the uniform cache at the time this draw command was created, this is used to upload the correct uniform values when this draw command is executed by the renderer
